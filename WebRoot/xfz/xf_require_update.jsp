...
<%
	...
	try {
		...
		case 3:
			// 新添
			id = Data.sequence("xfz_xf_require","id");
			sql = "";
			...
			sql += " ) ";
			sql += " INSERT INTO xfz_xf_require(id,title,remark,status,created_user) ";
			sql += " SELECT "+id+",title,remark,status,'"+uid+"' FROM T1 ";
			break;
		case 4:
			// 编辑
			sql = "";
			...
			sql = "UPDATE xfz_xf_require SET " + sql;
			sql += " WHERE id='" + id + "' ";
			break;
		case 5:
			sql += " UPDATE xfz_xf_require SET status=0 WHERE id IN (" + com.swufe.toolkit.StringUtil.strComma2Singlequotes(id) + ")";   
			break;
		}
