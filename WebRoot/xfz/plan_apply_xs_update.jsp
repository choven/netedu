...
<%
	...
	try {
		...
		case 3:
			...
			sql += " ) ";
			sql += " INSERT INTO xfz_plan_apply_xs(site_code,start_batch_code,target_xs,remark,status,created_user) ";
			sql += " SELECT site_code,start_batch_code,target_xs,remark,status,'"+uid+"' FROM T1 ";
			break;
		case 4:
			// 编辑
			sql = "";
			...
			sql = "UPDATE xfz_plan_apply_xs SET " + sql;
			sql += " WHERE id='" + id + "' ";
			break;
		case 5:
			sql += " UPDATE xfz_plan_apply_xs SET status=0 WHERE id IN (" + com.swufe.toolkit.StringUtil.strComma2Singlequotes(id) + ")";   
			break;
		}
