...
<%
	...
	try {
		...
		case 3:
			...
			sql += " ) ";
			sql += " INSERT INTO xfz_course_class(code,title,remark,status,created_user) ";
		...
		case 4:
			...
			sql = "UPDATE xfz_course_class SET " + sql;
			sql += " WHERE id='" + id + "' ";
			break;
		case 5:
			sql += " UPDATE xfz_course_class SET status=0 WHERE id IN (" + com.swufe.toolkit.StringUtil.strComma2Singlequotes(id) + ")";   
			break;
		}
