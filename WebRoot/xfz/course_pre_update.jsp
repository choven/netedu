...
<%
	...
	try {
		...
		case 3:
			...
			sql += " ) ";
			sql += " INSERT INTO xfz_course_pre(course_code,pre_course_code,created_user) ";
			sql += " SELECT course_code,pre_course_code,'"+uid+"' FROM T1 ";
			break;
		case 4:
			// 编辑
			sql = "";
			...
			sql = "UPDATE xfz_course_pre SET " + sql;
			sql += " WHERE id='" + id + "' ";
			break;
		case 5:
			sql += " delete from  xfz_course_pre  WHERE id IN (" + com.swufe.toolkit.StringUtil.strComma2Singlequotes(id) + ")";   
			break;
		}
