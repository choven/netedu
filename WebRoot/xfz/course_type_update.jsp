...
<%
	...
	try {
		...
		case 3:
			// 新添
			String code = Data.sequence("xfz_course_type","code");
			sql = "";
			...
			sql += " ) ";
			sql += " INSERT INTO xfz_course_type(code,title,remark,status,created_user) ";
			sql += " SELECT "+code+",title,remark,status,'"+uid+"' FROM T1 ";
			break;
		case 4:
			// 编辑
			sql = "";
			...
			sql = "UPDATE xfz_course_type SET " + sql;
			sql += " WHERE id='" + id + "' ";
			break;
		case 5:
			sql += " UPDATE xfz_course_type SET status=0 WHERE id IN (" + com.swufe.toolkit.StringUtil.strComma2Singlequotes(id) + ")";   
			break;
		}
