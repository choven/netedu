...
<%
	...
	try {
		...
		case 3:
			...
			sql += " ) ";
			sql += " INSERT INTO xfz_xf_require_detail(require_id,course_type_code,is_optional,min_xf,created_user) ";
			sql += " SELECT require_id,course_type_code,is_optional,min_xf,'"+uid+"' FROM T1 ";
			break;
		case 4:
			// 编辑
			sql = "";
			...
			sql = "UPDATE xfz_xf_require_detail SET " + sql;
			sql += " WHERE id='" + id + "' ";
			break;
		case 5:
			sql += " delete from  xfz_xf_require_detail WHERE id IN (" + com.swufe.toolkit.StringUtil.strComma2Singlequotes(id) + ")";   
			break;
		}
