...
<%
    ...
    try {
        ...
        switch (ActionID) {
            case 3:
                // 新添
                id = Data.sequence("user_group", "id");
                sql = "";
                ...
                sql += " ) ";
                sql += " INSERT INTO user_group(id,name,status,created_user) ";
            ...
            case 4:
                ...
                sql = "UPDATE user_group SET " + sql;
                sql += " WHERE id='" + id + "' ";
                break;
            case 5:
                sql = " UPDATE user_group SET status=0 WHERE id IN (" + stringUtil.strComma2Singlequotes(id) + ")";
                break;
        }
