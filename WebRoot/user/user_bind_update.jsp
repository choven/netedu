    ...
    try {
        ...
        switch (ActionID) {
            case 3:
                ...
                sql += " ) ";
                sql += " INSERT INTO user_bind([user_id],[bind_uid] ,[bind_title] ,[bind_pwd],[bind_user_type],open_type,[status]) ";
                sql += " SELECT '" + login.getUserId() + "',bind_uid,bind_title,bind_pwd,bind_user_type,open_type,status FROM T1 ";
                break;
            case 4:
                // 编辑
                sql = "";
                ...
                sql = "UPDATE user_bind SET " + sql;
                sql += " WHERE id='" + id + "' ";
                break;
            case 5:
                sql = " update  user_bind  set status=0 WHERE id IN (" + stringUtil.strComma2Singlequotes(id) + ")";
                break;
        }
