...
public class CnToSpell {
	 ...
	 * @return
	 */
	public static String getFullSpell(String cnStr, boolean bUpperCase) {
	...
	public static String getFirstSpell(String cnStr) {
		return getFirstSpell(cnStr, true);
	}
	 ...
	 * @return
	 */
	public static String getFirstSpell(String cnStr, boolean bUpperCase) {
		if (null == cnStr || "".equals(cnStr.trim())) {
			return cnStr;
		}
		char[] chars = cnStr.toCharArray();
	...
	public static void main(String[] args) {
		String str = null;
		str = "小红帽";
		System.out.println("全部Spell=" + CnToSpell.getFullSpell(str));
		System.out.println("全部Spell=" + CnToSpell.getFullSpell(str, true));
		System.out.println("首字母Spell=" + CnToSpell.getFirstSpell(str));
		
		System.out.println(com.swufe.toolkit.StringUtil.getFirstSpell("鲜海"));
	}
}